...
# TODO(Carden): Move the Detection tuple into this file.
# TODO(Carden): Write functions to convert to and from Detection Tuples
# TODO(Carden): Test theta update, test tgt_id assignment.
# TODO(Carden): Add a zombie frame counter.
